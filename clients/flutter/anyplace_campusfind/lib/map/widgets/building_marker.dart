...
class BuildingMarker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pinColor = isSelected ? MapTheme.markerSelected : MapTheme.markerColor;
            ...
            if (isSelected)
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: MapTheme.markerSelected.withValues(alpha: 0.35),
                  boxShadow: [
                    BoxShadow(
                      color: MapTheme.markerSelected.withValues(alpha: 0.6),
                      blurRadius: 12,
                      spreadRadius: 2,
                    ),
                  ],
